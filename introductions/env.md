...
这使得无人机从“较暗走廊”向“亮出口”过渡时，出现典型逆光挑战。
...
| `sun_glare` | `_build_sun_glare_voxel_layout()` | 两侧走廊墙 + 出口收窄 + 顶横梁（例如 `x≈3.45` 处有立柱/顶梁） | 速度与 margin 保持默认 |
...
- `sun_glare`：在“太阳区域 + 出口区域”制造曝光惩罚与有效性下降
