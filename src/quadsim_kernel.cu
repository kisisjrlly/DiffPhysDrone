...
__device__ __forceinline__ void d455_quality_effect_core(
    ...
    if (regime_id == 0) {
        ...
        const scalar_t exposure_bloom = sigmoid_d((e01 - scalar_t(0.58)) / scalar_t(0.100)) *
        ...
        const scalar_t safe = sigmoid_d((scalar_t(0.48) - p) / scalar_t(0.080)) *
                              ...
                              sigmoid_d((scalar_t(0.42) - g01) / scalar_t(0.09));
        const scalar_t very_safe = sigmoid_d((scalar_t(0.28) - p) / scalar_t(0.060)) *
                                   sigmoid_d((scalar_t(0.34) - e01) / scalar_t(0.070)) *
