...
map<int, vector<pair<int, Eigen::Matrix<double, 7, 1>>>> FeatureTracker::trackImage(double _cur_time, const cv::Mat &_img, const cv::Mat &_img1)
{
    ...
    */
    ...
    if (1)
    {
        ...
        // cnt++;
        // sum_1 += (int)ids.size();
        // sum_2 += (int)n_pts.size();
        // sum_n += (n_pts.size()+(int)ids.size());
        // if((cnt == 50) || (cnt == 100) || (cnt == 150)) {
        //     printf("\033[41;37mcnt %d\033[0m\n", cnt);
        //     printf("track cnt %d\n", (int)ids.size());
        //     printf("point from non-gpu: %d\n",(int)n_pts.size());
        //     printf("track point from non-gpu: %d\n",sum_1);
        //     printf("detect point from non-gpu: %d\n",sum_2);
        ...
        else
        {
            if (n_max_cnt > 0)
            {
                ...
                //     printf("\033[41;37mcnt %d\033[0m\n", cnt);
                //     printf("track cnt %d\n", (int)ids.size());
                //     printf("point from gpu: %d\n",(int)n_pts.size());
                //     printf("track point from gpu: %d\n",sum_1);
                //     printf("detect point from gpu: %d\n",sum_2);
    ...
    // printf("\033[41;37mfeature track whole time %f\033[0m\n", t_r.toc());
    return featureFrame;
}
