...
def build_parser():
    ...
    p.add_argument("--gray_blur_scale", type=float, default=1.0)
    p.add_argument("--gray_blur_kernel_size", type=int, default=5)
    p.add_argument("--gray_dark_threshold", type=float, default=0.05)
    p.add_argument("--gray_saturation_mode", choices=["ste", "hard", "soft"], default="ste")
    p.add_argument("--gray_soft_clip_beta", type=float, default=6.0)
