...
def build_env(batch_size: int, args, device, *, eval_mode: bool = False) -> Env:
    return Env(
        ...
        simple_gate_y_min=args.simple_gate_y_min,
        simple_gate_y_max=args.simple_gate_y_max,
        simple_gate_half_y=args.simple_gate_half_y,
        simple_gate_half_y_min=args.simple_gate_half_y_min,
        simple_gate_half_y_max=args.simple_gate_half_y_max,
        simple_gate_half_z=args.simple_gate_half_z,
        simple_gate_z=args.simple_gate_z,
