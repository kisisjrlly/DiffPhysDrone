...
\bottomrule
\end{tabular}
\caption{Primary closed-loop navigation results over 300 episodes per method. Brackets denote 95\% confidence intervals: Wilson intervals for binary outcomes and bootstrap intervals over episodes for fill. Deltas are relative to the fixed-camera baseline.}
